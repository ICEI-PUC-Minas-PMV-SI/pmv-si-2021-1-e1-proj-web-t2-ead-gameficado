...
Através de pesquisas online, formulários e entrevistas com pais de crianças em idade escolar, foi possível levantar as principais características do projeto, refinando os dados coletados e retratando em forma de personas e histórias de usuários da plataforma EaD Gameficado.
...
|ID| Restrição                                             |
|--|-------------------------------------------------------|
|RE-01| O projeto deverá ser entregue até o final do semestre letivo, não podendo extrapolar a data e 11/07/2021 |
